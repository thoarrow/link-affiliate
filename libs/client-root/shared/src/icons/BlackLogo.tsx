...
function BlackLogo(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
            viewBox="0 0 95.7 95.7">
            <title>logo</title>
            <path d="M86.7,25.3c-0.2-0.3-0.6-0.4-1-0.2l-6.5,6.3c-0.2,0.2-0.3,0.5-0.1,0.8c8.7,17.3,1.9,38.4-15.4,47.2
